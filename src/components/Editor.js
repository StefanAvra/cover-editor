...
export default function Editor() {
  ...
  const imageOptions = {
    ...
    c: ["Deeploma 1", "Deeploma 2", "Deeploma 3"],
  };
  ...
  const dlIcon = (
    <svg
      ...
      style={{
        fill: getComputedStyle(document.body).getPropertyValue("--bg-color"),
        height: "1em",
        position: "absolute",
        bottom: "5px",
        right: "7px",
  ...
  return (
    <div className={styles.Editor}>
      ...
      <div className={styles.settings}>
        ...
        ></CoverSelect>
        <Button onClick={resetSettings} name="Reset" iconSvg={resetIcon} />
